...
/// Only inserts when all three tables are empty — safe to call on every startup.
/// </summary>
public static class DemoDataSeeder
{
    public static async Task SeedAsync(PchDbContext db)
    {
        bool hasAny = db.Tasks.Any() || db.Emails.Any() || db.NewsItems.Any();
        if (hasAny)
            return;
        ...
        db.Emails.AddRange(
            ...
            new Email
            {
                ...
                LinkedTaskId    = null, // resolved after tasks are saved
